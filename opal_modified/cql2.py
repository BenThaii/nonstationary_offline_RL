...
class CQLTrainer(TorchTrainer):
	def __init__(
		...
		'''
			...
			optimization:
				...
				- policy: the (primitive) policy network
				- qf1: q-function 1
				- qf2: q-function 2
		...
		self.latent_policy_train_epochs = latent_policy_train_epochs		#only train the latent policy for this number of epochs
		...
		#training the latent policy (encoder from OPAL)?
	...
	def train_from_torch(self, batch):        
		...
		actions = batch['actions']		#is this the latent trajectory encoding z
